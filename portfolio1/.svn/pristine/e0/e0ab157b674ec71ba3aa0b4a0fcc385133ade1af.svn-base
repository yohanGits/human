...
<table class="table table-striped my-5 mx-1" style="border: 1px solid #dddddd; width: 80%; ">
	...
	<tr>
		<td><button class="btn btn-primary btn-sm" id="btnModify" style="width:60px; float: right; border-color: #052387; font-family: 'BBTreeGB';background-color: #052387;">수정</button></td>
	</tr>
</table>
</form>
</main>
