...
<table class="table table-striped">
	...
	<c:if test="${member.id == board.id}">
		...
		<button type="submit" class="btn btn-primary btn-sm mx-1" onclick="location.href='${pageContext.request.contextPath}/board/modify?bno=${board.bno}'" style="width:60px; border-color: #052387; font-family: 'BBTreeGB';background-color: #052387;">수정</button>
	</c:if>	
        <button type="submit" class="btn btn-primary btn-sm mx-1" onclick="location.href='${pageContext.request.contextPath}/board/list'" style="width:60px; border-color: #052387; font-family: 'BBTreeGB';background-color: #052387;">목록</button>
	</div>
