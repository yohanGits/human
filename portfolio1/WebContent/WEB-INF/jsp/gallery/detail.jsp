...
<table class="table table-striped">
	...
	<tr>
		<td colspan="2"><img style="display: block; margin: 0 auto;" class="border border-secondary" src="${pageContext.request.contextPath}/display?filename=${board.attachs[0].path}/s_${board.attachs[0].uuid}"></td>
	</tr>
</table>
	...
	<c:if test="${member.id == board.id}">
		...
		<button type="submit" class="btn btn-primary btn-sm mx-1" onclick="location.href='${pageContext.request.contextPath}/gallery/modify?bno=${board.bno}'" style="width:60px; font-family: 'BBTreeGB';background-color: #052387;">수정</button>
	</c:if>	
        <button type="submit" class="btn btn-primary btn-sm mx-1" onclick="location.href='${pageContext.request.contextPath}/gallery/list'" style="width:60px; font-family: 'BBTreeGB';background-color: #052387;">목록</button>
	</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" id="btnmd">수정</button>
